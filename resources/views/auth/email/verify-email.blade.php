                                                                    ...
                                                                    <tr>
                                                                        <td class="padding-copy">
                                                                            <table width="100%" border="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <img src="\img\Soon_solo_logo.png"
                                                                                            border="0"
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        ...
                                                                        class="padding-copy">Ce l'hai quasi fatta </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center"
                                                                        style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                                                        class="padding-copy">Siamo felici di
                                                                        accoglierti, abbiamo ricevuto la tua richiesta
                                                                        di iscrizione a Soon.it, manca davvero poco,
                                                                        dovresti prima confermare la tua mail, clicca
                                                                        sul bottone qui sotto <br> ↓↓↓↓↓↓</td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                                        ...
                                                                        <table border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="center"><a href="#"
                                                                                        ...
                                                                                        class="mobile-button">Learn How
                                                                                        &rarr;</a></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="center"
                                                                                    style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                                                                    class="padding-copy">Non funziona?
                                                                                    <br>allora clicca qui:
                                                                                    https://www.soon.it/email-verification
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
